...
export default function Facilities() {
  ...
  const highlights = [
    { icon: Sun, label: "Solar Power", desc: "Sustainable energy initiative", color: "from-amber-500 to-yellow-500" },
    { icon: Droplets, label: "Rainwater Harvesting", desc: "Water conservation", color: "from-cyan-500 to-blue-500" },
    { icon: TreePine, label: "Green Campus", desc: "Environment-friendly", color: "from-emerald-500 to-green-500" },
    { icon: Heart, label: "Medical Room", desc: "First-aid facilities", color: "from-rose-500 to-red-500" },
  ];

  const quickStats = [
    { value: "25+", label: "Facilities", icon: Building2, color: "from-teal-400 to-cyan-500" },
    { value: "1000+", label: "Happy Students", icon: Users, color: "from-emerald-400 to-green-500" },
    { value: "50+", label: "Sports Activities", icon: Trophy, color: "from-amber-400 to-orange-500" },
    { value: "98%", label: "Satisfaction Rate", icon: Star, color: "from-violet-400 to-purple-500" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50 overflow-x-hidden">
      <Navigation />
      ...
      <section className="relative text-white py-20 sm:py-24 lg:py-28 overflow-hidden min-h-[550px] flex items-center">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1571260899304-425eee4c7efc?w=1920&h=1080&fit=crop')`,
          }}
        />
        {/* Dark Overlay with Gradient */}
        <div className="absolute inset-0 bg-gradient-to-r from-teal-900/90 via-cyan-900/80 to-blue-900/70" />
            ...
            {quickStats.map((stat, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-base sm:text-lg md:text-xl font-bold text-slate-900 group-hover:text-teal-600 transition-colors">
                    {stat.value}
                  </div>
      ...
      <section ref={sectionRef} className="py-8 sm:py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12 animate-on-scroll opacity-0 translate-y-10">
            <div className="inline-flex items-center gap-2 bg-teal-100 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-4">
              <Building2 className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600" />
              <span className="text-xs sm:text-sm font-medium text-teal-600">Explore Our Facilities</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mb-2 sm:mb-4">
              Our <span className="bg-gradient-to-r from-teal-500 to-cyan-500 bg-clip-text text-transparent">State-of-the-Art</span> Facilities
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6 sm:mb-8 animate-on-scroll opacity-0 translate-y-10">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 sm:pl-10 pr-10 py-2.5 sm:py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-teal-100 focus:border-teal-500 transition-all duration-300 text-sm sm:text-base"
              />
              {searchTerm && (
                <button
              ...
              {filteredFacilities.map((facility, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1 sm:mb-2 group-hover:text-teal-600 transition-colors">
                      {facility.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-teal-600 group-hover:translate-x-1 transition-all duration-300" />
                    </div>
                  </div>
                );
              })}
      ...
      {/* Why Our Facilities */}
      <section className="bg-gradient-to-br from-white to-teal-50/50 py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12 animate-on-scroll opacity-0 translate-y-10">
            <div className="inline-flex items-center gap-2 bg-emerald-100 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-4">
              <Award className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600" />
              <span className="text-xs sm:text-sm font-medium text-emerald-600">Why We Stand Out</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mb-2 sm:mb-4">
              Designed for <span className="bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Excellence</span>
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-slate-600 max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Award, title: "Quality Education", desc: "State-of-the-art learning environment", color: "from-teal-500 to-cyan-500" },
              { icon: Users, title: "Expert Guidance", desc: "Facilities supported by qualified staff", color: "from-indigo-500 to-purple-500" },
              { icon: Heart, title: "Student Well-being", desc: "Safe and nurturing environment", color: "from-rose-500 to-pink-500" },
              { icon: Globe, title: "Global Standards", desc: "World-class infrastructure", color: "from-emerald-500 to-teal-500" },
            ].map((item, i) => {
              const Icon = item.icon;
              return (
                <div
                ...
                >
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-slate-900 mb-1 sm:mb-2 group-hover:text-teal-600 transition-colors">
                    {item.title}
                  </h4>
          ...
          <div className={`max-w-3xl mx-auto text-center text-white transition-all duration-700 ${
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
              <Button 
                ...
                className="bg-white text-teal-600 hover:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 sm:gap-3"
              >
              ...
              <Button 
                ...
                className="border-2 border-white/50 hover:border-white text-white hover:bg-white/10 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm flex items-center justify-center gap-2 sm:gap-3"
              >
